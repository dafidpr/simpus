	 ...
	 <div class="col-lg-12">
		<div class="content-panel">
			<div class="container-fluid">
			  <section id="unseen">
			  <form action="<?php echo base_url('laporankembali/laporan'); ?>" method="post" class="user">
				 <div class="container-fluid">
					  <div class="form-group row  mb-3">
						...
						<button type="button" title="Cari Data" onclick="caridatakembali()" class="btn btn-primary btn-sm mb"><i class="fa fa-search"></i> Cari</button>
						<button type="submit" title="Export PDF" class="btn btn-primary btn-sm mb"><i class="fa fa-download"></i> Export PDF</button>
					  </div>
					</div>
				</form>
			   <div class="table-responsive">
				  <table class="table table-bordered table-condensed" id="laporankembali" width="100%">
					 <thead>
						<tr>
