<!-- Modal Input Petugas -->
<div class="modal fade" id="inputPetugasModal" tabindex="-1" role="dialog" aria-labelledby="inputPetugasModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title text-white" id="inputPetugasModal">Input Data Petugas</h4>
        </div>
        <div class="modal-body">
            <form action="<?php echo base_url('petugas/inputpetugas'); ?>" method="post" class="user">
                <div class="modal-body">
                     <div class="container-fluid">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-6">
                                <input type="text" name="jadwal" id="jadwal" class="form-control " placeholder="Jadwal Tugas">
                            </div>
							<div class="col-md-6">
